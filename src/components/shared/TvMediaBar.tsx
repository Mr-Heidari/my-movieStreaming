import {
  useGetSeriesImageById,
  useGetSeriesVideoById,
...
const TVMediaBar = () => {
  ...
  const { data: images, isPending: imageIsLoading } = useGetSeriesImageById({
    id: id || "",
  });

  const { data: videos, isPending: videoISLoading } = useGetSeriesVideoById({
    id: id || "",
  });
