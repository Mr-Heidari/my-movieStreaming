...
const CarouselPosterList = ({
  ...
  return (
    <div className=" flex flex-col gap-5 mt-5">
      <header>
        <h2 className=" text-white font-semibold text-xl md:text-3xl px-10">{title}</h2>
      </header>
        ...
        {isLoading ? (
          ...
          <>
            <Carousel className="w-full  cursor-pointer  ">
              ...
              <CarouselPrevious className="rounded-3xl border-none rounded-tl-none rounded-bl-none bg-black/50 hover:bg-red-600 absolute left-0 h-full md:w-20  w-12 items-center " />

              <CarouselNext className="rounded-3xl border-none rounded-tr-none rounded-br-none bg-black/50 hover:bg-red-600 absolute right-0 h-full md:w-20  w-12 items-center " />
            </Carousel>
          </>
        )}
      </main>
